 ...
 */
public class RealtorAllFlatsAdapter extends RecyclerView.Adapter<RealtorAllFlatsAdapter.AllOrdersViewHolder> {
    ...
    public RealtorAllFlatsAdapter(List<Order> orders) {
        this.orders = orders;
    }
